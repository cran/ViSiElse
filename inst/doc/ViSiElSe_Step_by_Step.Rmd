...
The process underlying making coffee corresponds to a 5 steps procedure.
  ...
  * 1- Taking the coffee (named “coffe”)
  * 2- Fill the machine with coffee (named “fill_coffe”)
...
When it is not manually defined, the function visielse computes the ViSibook associated this the dataset assuming the process is the ordered list of punctual actions given by the dataset's columns names. Also, it is possible to extract the ViSibook from an execution of the visielse function.
